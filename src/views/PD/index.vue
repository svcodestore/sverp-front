 ...
 * @LastEditors: Mok.CH
 * @LastEditTime: 2021-04-30 09:51:52
 * @FilePath: \sverp-front\src\views\PD\index.vue
-->
<template>
  <div>
    <div>
      <div class="search-row">
        ...
        <span>
          公司
          <a-select style="width:120px;" default-value="nothing" v-model="searchParam.comply_name">
            <a-select-option value="nothing">全部</a-select-option>
            <a-select-option value="A020">斯达文星</a-select-option>
            <a-select-option value="A021">斯达富</a-select-option>
            <a-select-option value="A022">杰仕通</a-select-option>
          </a-select>
        </span>
